...
export async function submitInquiry(
  ...
  const adminEmail = process.env.BREVO_FROM_EMAIL || settings?.contact_email || "hello@ggraphixc.vercel.app";
  ...
  const autoReply = await sendEmail({
    to: email,
    toName: name,
    subject: `Thanks — your brief is with ${brand}`,
    html: `
      <div style="font-family:Inter,Arial,sans-serif;max-width:560px;margin:0 auto">
        ...
        <p style="font-size:15px;line-height:1.7;color:#333">While you wait, you can browse a few <a href="${siteUrl}/projects">case studies</a> to see how we might work together.</p>
